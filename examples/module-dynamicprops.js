...
async function PrimaryNav(props) {
    const objectparams = Object.assign({}, props);
    const [items, setItems]=useState(objectparams?.dynamicProps?.items);

    if(!items){
        const dynamicProps=await getDynamicProps(objectparams);
